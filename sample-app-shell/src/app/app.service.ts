...
import { IModuleLoadOutput, ModuleLoadService } from 'src/shared/services/module-load.service';
...
export class AppService {
  ...
  getCompiledComponent(moduleName: string, componentName: string): Promise<any>  {
